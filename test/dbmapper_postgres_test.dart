...
defineTests() {
  group("PostgresDatabase", () {
    ...
    test("getType", () {
      ...
      var t2 = PostgresDatabase.getType(new Field("test",
          type: FieldType.integer));
      var t3 = PostgresDatabase.getType(new Field("test",
          type: FieldType.doubleType));
      var t4 = PostgresDatabase.getType(new Field("test",
          type: FieldType.date));
      var t5 = PostgresDatabase.getType(new Field("test",
          type: FieldType.boolType));
    ...
    test("buildCreateTableStatement", () {
      ...
      expect(stmnt, equals('CREATE TABLE "table" ("myField" text, "otherField" text)'));
    });
  });
}