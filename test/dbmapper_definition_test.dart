  ...
  group("Field", () {
    test("Constructor", () {
      ...
      var f3 = new Field("test",
          type: FieldType.integer, constraints: new Set.from([unique]));
      var f4 = new Field("test",
          type: FieldType.integer, constraints: new Set.from([autoIncrement]));
      ...
      expect(
          () => new Field("test",
              type: FieldType.text, constraints: new Set.from([autoIncrement])),
          throwsArgumentError);
    });
